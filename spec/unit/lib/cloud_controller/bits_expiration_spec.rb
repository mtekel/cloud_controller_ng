...
module VCAP::CloudController
  describe BitsExpiration do
    ...
    let(:config) do
      { expiration:
        {
          num_of_valid_packages_per_app_to_store: 5,
          num_of_staged_droplets_per_app_to_store: 5
        }
      }
    end
    ...
    let(:changed_config) do
      { expiration:
        {
          num_of_valid_packages_per_app_to_store: 10,
          num_of_staged_droplets_per_app_to_store: 10
        }
      }
    end
