    ...
    describe 'POST /v2/service_brokers' do
      ...
      describe 'private brokers' do
        ...
        context 'when the request includes a space_guid' do
          ...
          it 'returns a 409 if a another broker (private or public) exists with that name' do
          ...
          it 'returns a 409 if a another broker (private or public) exists with that url' do
            stub_catalog
