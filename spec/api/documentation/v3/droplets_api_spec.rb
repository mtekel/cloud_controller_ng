  ...
  get '/v3/droplets/:guid' do
    ...
    example 'Get a Droplet' do
      expected_response = {
        ...
        'lifecycle'             => { 'stack' => nil, 'buildpack' => buildpack_git_url },
          ...
          'resources'  => [
            {
              ...
              'lifecycle'              => { 'stack' => nil, 'buildpack' => 'https://github.com/cloudfoundry/my-buildpack.git' },
            ...
            },
            {
              ...
              'lifecycle'              => { 'stack' => nil, 'buildpack' => buildpack.name },
