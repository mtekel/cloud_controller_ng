...
module VCAP::CloudController
  class Stagers
    ...
    def messenger_for_prorocol(protocol)
    ...
    def diego_docker_stager(app)
      ...
      Diego::Stager.new(app, messenger_for_prorocol(protocol), completion_handler, @config)
    end
    ...
    def diego_package_stager(package)
      ...
      Diego::V3::Stager.new(package, messenger_for_prorocol(protocol), completion_handler, @config)
    end
  end
end
